...
public class Mission extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.navi_home:
                Intent intent_home = new Intent(Mission.this, MainActivity.class);
            ...
            case R.id.navi_mission:
                Intent intent_mission = new Intent(Mission.this, Mission.class);
                finish();
                // start the activity connect to the specified class
            ...
            case R.id.navi_rank:
                Intent intent_rank = new Intent(Mission.this, Rank.class);
            ...
            case R.id.navi_quiz:
                Intent intent_quiz = new Intent(Mission.this, Quiz.class);
            ...
            case R.id.navi_crm:
                Intent intent_crm = new Intent(Mission.this, SurveyCrm.class);
